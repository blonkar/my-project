...
class MedicinesControllerTest < ActionController::TestCase
  ...
  test "should create medicine" do
    assert_difference('Medicine.count') do
      post :create, medicine: { expiry_date: @medicine.expiry_date, name: @medicine.name, price: @medicine.price, quantity: @medicine.quantity, selling_quantity: @medicine.selling_quantity }
    end
  ...
  test "should update medicine" do
    patch :update, id: @medicine, medicine: { expiry_date: @medicine.expiry_date, name: @medicine.name, price: @medicine.price, quantity: @medicine.quantity, selling_quantity: @medicine.selling_quantity }
    assert_redirected_to medicine_path(assigns(:medicine))
  end
